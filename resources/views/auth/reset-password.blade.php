...
<head>
    ...
    <title>Definir Senha | Sitemas</title>
    ...
    <div class="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">
                Seja bem-vindo à Sitemas
            </h2>
            <p class="mt-2 text-center text-sm text-gray-600">
                Falta pouco! Defina sua senha para acessar seu novo painel.
            </p>
        </div>
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div class="bg-white px-4 py-8 shadow-xl border border-gray-100 sm:rounded-2xl sm:px-10">
                ...
                <form method="POST" action="{{ route('password.update') }}" class="space-y-6">
                    ...
                    <div>
                        <label for="password" class="block text-sm font-medium text-gray-700 text-left">Nova
                            Senha</label>
                        <div class="mt-1">
